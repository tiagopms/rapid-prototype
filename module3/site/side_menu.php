...
<ul>
	<?php
        ...
        while($stmt->fetch()){
        	...
        	if ($user_logged) {
        		echo '<li><a'.$current_category_id.' href="home.php?category='.process_text($category_id).'"> '.process_text($category_name).' </a></li>';
        	} else {
                echo '<li><a'.$current_category_id.' href="login.php?category='.process_text($category_id).'"> '.process_text($category_name).' </a></li>';
            }
        }
